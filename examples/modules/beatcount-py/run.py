...
# hello-py's copy of this comment for the full rationale.
...
def draw(state):
    black = palette_color("off")
    gray = palette_color("gray_green")  # matches widgets.Default.Gray on the Go side
